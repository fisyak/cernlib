  ...
  if( ufun == NULL ) {
    ...
    for( i = 1; i <= npar; i++ ) {
      if( which[i] == 1 )
        ...
        printf( "%s%s", comma, strfromd9( dlist[i], 0 ) );
      comma = ",";
    }
    printf( ")\n" );
...
case 4:{
          ...
          if( yypvt[-0].dval <= maxint && yypvt[-0].dval >= -maxint && (int)yypvt[-0].dval == yypvt[-0].dval ) {
            ...
            result = strdup( strfromd9( yypvt[-0].dval, 0 ) );
          }
...
case 48:{
          char *s1 = strdup( strfromd9( yypvt[-2].dval, 0 ) );
          yyval.dval = (strcmp( s1, strfromd9( yypvt[-0].dval, 0 ) ) == 0);
          free( s1 );
        } break;
case 49:{
          char *s1 = strdup( strfromd9( yypvt[-2].dval, 0 ) );
...
case 52:{
          yyval.dval = (strcmp( strfromd9( yypvt[-2].dval,0 ), yypvt[-0].sval ) == 0);
          free( yypvt[-0].sval );
        } break;
...
case 60:{
          yyval.sval = strdup( strfromd9( yypvt[-3].dval, 0 ) );
...
case 77:{
          ...
          if( n >= 2 && yyval.sval[0] == '\'' && yyval.sval[n-1] == '\'' ) {
            ...
            memmove( yyval.sval, yyval.sval + 1, strlen(yyval.sval + 1) +1);
...
case 87:{
	    ...
	    memmove( yyval.sval, yyval.sval + k - 1, strlen(yyval.sval + k - 1) +1 );
