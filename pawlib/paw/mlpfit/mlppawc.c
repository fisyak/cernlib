...
/* US add missing declarations of external functions */
int SaveWeights(char *, int);
int LoadWeights(char *, int *);
int ReadPatterns(char *, int, int *, int *, int *);
