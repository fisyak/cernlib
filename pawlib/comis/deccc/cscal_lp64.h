 ...
 * -- Kevin McCarty
 *
 * 5/8/2023 on aarm64 the stack grows downward as for ALPHA. Not clear where the data
 * segment starts so we leave it as from amd64 and hope it is OK.
 */
...
#elif defined (__aarm64__) && defined(__DARWIN__)
# define autotest(_var) ((unsigned long)(_var) < 0x20000000UL)
#else /* amd64 and aarch64 */
