...
########################################################################
   ldirs =  "cdf/Imakefile cgpack/Imakefile erdecks/Imakefile erpremc/Imakefile gbase/Imakefile gcons/Imakefile".split(" ") 
   if (FREE==0):
     ldirs +=  "block/Imakefile fiface/Imakefile fluka/Imakefile".split(" ") 
   ...
   ldirs += "gparal/Imakefile gphys/Imakefile gscan/Imakefile gstrag/Imakefile gtrak/Imakefile gxint/Imakefile matx55/Imakefile miguti/Imakefile neutron/Imakefile".split(" ")
   if (FREE==0):
     ldirs += "peanut/Imakefile miface/Imakefile".split(" ")
