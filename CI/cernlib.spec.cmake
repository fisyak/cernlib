...
Source0:    %{version}_src-free.tar.gz
...
export FC=gfortran
%endif
cmake  -DCERNLIB_NO_SUFFIX=0 -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF -S %{version}/src -DCERNLIB_BUILD_SHARED=ON -DCERNLIB_USE_INTERNAL_XBAE=OFF -DCERNLIB_USE_INTERNAL_LAPACK=OFF  -DCMAKE_Fortran_COMPILER=${FC} -DCMAKE_INSTALL_PREFIX=/usr -DCMAKE_INSTALL_LIBDIR=%{_libdir}/cernlib/%{version}/lib -DCMAKE_INSTALL_INCLUDEDIR=%{_includedir}/cernlib/%{version} -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF
%cmakeB
%else
%cmake  -DCERNLIB_NO_SUFFIX=0 -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF -S %{version}/src -DCERNLIB_BUILD_SHARED=ON -DCERNLIB_USE_INTERNAL_XBAE=OFF -DCERNLIB_USE_INTERNAL_LAPACK=OFF -DCMAKE_INSTALL_LIBDIR=%{_libdir}/cernlib/%{version}/lib -DCMAKE_INSTALL_INCLUDEDIR=%{_includedir}/cernlib/%{version} -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF
%cmakeB
%endif

%if 0%{?suse_version}
export FC=gfortran
%cmake  -DCERNLIB_NO_SUFFIX=1 -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF -S ../%{version}/src -DCERNLIB_BUILD_SHARED=ON -DCERNLIB_USE_INTERNAL_XBAE=OFF -DCERNLIB_USE_INTERNAL_LAPACK=OFF -DCMAKE_INSTALL_LIBDIR=%{_libdir}/cernlib/%{verdir}/lib -DCMAKE_INSTALL_INCLUDEDIR=%{_includedir}/cernlib/%{verdir} -DCMAKE_VERBOSE_MAKEFILE:BOOL=OFF
%cmake_build
%endif
...
chrpath --delete $RPM_BUILD_ROOT%{_libdir}/cernlib/%{verdatadir}/lib/lib*so.*20*
%endif
%check
...
/etc/ld.so.conf.d/*
%dir %{_libdir}/cernlib/
%dir %{_libdir}/cernlib/%{verdatadir}
%dir %{_libdir}/cernlib/%{verdatadir}/lib
%dir %{_libdir}/cernlib/%{verdatadir}/bin
%{_libdir}/cernlib/%{verdatadir}/lib/*.so.*
...
%files static
%defattr(-,root,root,-)
%{_libdir}/cernlib/%{verdatadir}/lib/*.a

%files utils
%defattr(-,root,root,-)
%{_datadir}/doc/cernlib-utils/cernlib-%{verdatadir}.csh
%{_datadir}/doc/cernlib-utils/cernlib-%{verdatadir}.sh
%{_bindir}/cernlib*
...
%dir %{_libdir}/cernlib/%{verdatadir}
%dir %{_libdir}/cernlib/%{verdatadir}/bin
%{_libdir}/cernlib/%{verdatadir}/bin/pawX11%{?compiler_string}
...
%dir %{_libdir}/cernlib/%{verdatadir}
%dir %{_libdir}/cernlib/%{verdatadir}/bin
%{_libdir}/cernlib/%{verdatadir}/bin/dzeX11%{?compiler_string}
...
%dir %{_libdir}/cernlib/%{verdatadir}
%dir %{_libdir}/cernlib/%{verdatadir}/bin
%{_libdir}/cernlib/%{verdatadir}/bin/pawX11
%{_datadir}/X11/app-defaults/*Paw++
%{_datadir}/icons/hicolor/
%{_mandir}/man1/paw*.1*
...
%dir %{_libdir}/cernlib/%{verdatadir}
%dir %{_libdir}/cernlib/%{verdatadir}/bin
%{_libdir}/cernlib/%{verdatadir}/bin/dzeX11
%{_bindir}/dzeX11
%{_bindir}/fatmen
%{_bindir}/fatsrv
%{_bindir}/kuesvr
...
%changelog
* Wed Jun 24 2026 Ulrich Schwickerath <ulrich.schwickerath@cern.ch> 2026-06
- SPLIT renamed to SPLITDVN
* Wed Mar 4 2026 Ulrich Schwickerath <ulrich.schwickerath@cern.ch> 2026-01
...
* Wed Jun 12 2024 Ulrich Schwickerath <ulrich.schwickerath@cern.ch> 2024-06
 - bump version
* Mon Oct 16 2023 Ulrich Schwickerath <ulrich.schwickerath@cern.ch> 2023-10
 - bump version
